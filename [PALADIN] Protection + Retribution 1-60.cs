    ...
    namespace something
    {
        public class EmuPaladin : CustomClass
        {
            ...
            public override void Fight()
            {
                ...
                if (this.Target.HealthPercent >= 50)
                {
                ...
                {
                    if (this.Player.CanUse("Judgement") && this.Player.GotBuff("Seal of Command") || this.Player.GotBuff("Seal of Righteousness"))
                    {
            ...
            {
                /*Blessings*/
                if (this.Player.GetSpellRank("Blessing of Wisdom") != 0)
                {
                ...
                else if (this.Player.GetSpellRank("Blessing of Might") != 0)
                {
