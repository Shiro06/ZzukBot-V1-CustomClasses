    ...
    namespace something
    {
        public class Schouten_Priest : CustomClass
        {
            ...
            public override bool Buff()
            {
             ...
             if (this.Player.GetSpellRank("Shadowform") != 0)
                {
             ...
             if (this.Player.GetSpellRank("Shadow Protection") != 0)
                {
                    if (!this.Player.GotBuff("Shadow Protection"))
                    {
                        this.Player.Cast("Shadow Protection");
                        return false;
                    }
                }
