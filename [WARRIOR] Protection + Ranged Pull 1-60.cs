    ...
    namespace something
    {
        public class EmuWarrior : CustomClass
        {
            ...
            {
                if (this.Player.GetSpellRank("Shoot Bow") != 0 && this.Player.CanUse("Shoot Bow"))
                {
            ...
            public override void Fight()
            {
                ...
                //buffs
                if (this.Player.GetSpellRank("Battle Shout") != 0 && this.Player.Rage >= 10 && !this.Player.GotBuff("Battle Shout"))
                {
                    this.Player.Cast("Battle Shout");
                }

                if (this.Player.GetSpellRank("Blood Fury") != 0 && this.Player.CanUse("Blood Fury"))
                {
                    this.Player.Cast("Blood Fury");
                }

                if (this.Player.Rage <= 50 && this.Player.HealthPercent >= 50 && this.Player.GetSpellRank("Bloodrage") != 0 && this.Player.CanUse("Bloodrage"))
                {
                ...
                {
                    if (TargetCanBleed() && !this.Target.GotDebuff("Rend") && this.Player.Rage >= 10 & this.Target.HealthPercent > 50)
                    {
                ...
                {
                    if (!this.Target.GotDebuff("Shield Bash") && this.Player.Rage >= 10 && this.Player.CanUse("Shield Bash"))
                    {
                ...
                {
                    if (!this.Target.GotDebuff("War Stomp"))
                    {
                ...
                {
                    if (!this.Target.GotDebuff("Concussion Blow") && this.Player.Rage >= 15)
                    {
